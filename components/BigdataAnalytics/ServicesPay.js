...
export default function ServicesPay() {
  ...
  return (
    ...
    {/*                   <button
                      ...
                      <button className="btn btn-primary"  type="submit" name="amount" value="350" role="link" >6F Standard</button>
                    </div>
                  </div>
                </div>
                <div className="col-lg-4 col-md-6">
    ...
    {/*                   <button
                      ...
                      <button className="btn btn-primary" type="submit" name="amount"value ="600" role="link" >6F Pro</button>
                    </div>
                  </div>
                </div>
              </div>
