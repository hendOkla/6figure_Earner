                                      ...
                                      <>
                                          ...
                                          <div className="blog-details-area ptb-80">
                                              <div className="container">
                                                  <div className="row">
                                                    <div>
                                                        <iframe src={`https://docs.google.com/viewer?url=${encodeURIComponent(`https://6figure-earner.com/LarReApi/public/${item[`book_${locale}`]}`)}&embedded=true`} width="95%" height="1500px" frameBorder="0" scrolling="auto"></iframe>
                                                    </div>
                                                  </div>
                                              </div>
                                          </div>   
